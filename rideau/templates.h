...
char MAIN_page[] PROGMEM = R"=====(
  <!DOCTYPE html>
    ...
    <div class='center'>
      <h1 style='text-align:center;color:indigo'>Rideau Aimen </h1>
      <a href='/up' style='display: inline-block;padding: 20px 15px;color: #fff;background:#0099cc;'>UP</a><br/>
      <a href='/pause' style='display: inline-block;padding: 20px 15px;color: #fff;background:lime; margin-top:10px'>PAUSE</a><br/>
      <a href='/down' style='display: inline-block;padding: 20px 15px;color: #fff;background:#ff1a1a; margin-top:10px'>DOWN</a>
    </div>
    </body>
    </html>
)=====";
